 ...
 <footer class="footer">
            <div class="footer-body">
                <ul class="left-panel list-inline mb-0 p-0">
                    <li class="list-inline-item"><a href="javascript:void(0);">Copyright © 2024 Truxcargo Pvt. Ltd.</a></li>
                </ul>
                <div class="right-panel">
                    ©<script>
                    2024
                    </script> <span>TRUXCARGO</span>, Made with
                    ...
                    </span> by <a href="www.truxcargo.com" target="_blank">TRUXCARGO</a>.
                </div>
            </div>
        </footer>
        <!-- Footer Section End -->
